...
public class MatchGoalPlusHandler(LeagueManagerContext leagueManagerContext) : IRequestHandler<MatchGoalPlusCommand>
{
    private readonly LeagueManagerContext _LeagueManagerContext = leagueManagerContext;

    public async Task Handle(MatchGoalPlusCommand request, CancellationToken cancellationToken)
    {
